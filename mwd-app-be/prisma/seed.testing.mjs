...
const CONFIG = {
  ...
  sessions: [
    ...
    { code: 'TEST-MWD-EMPTY', wellName: 'TEST-WELL-C', status: ['PLANNED', 'planned', 'INACTIVE', 'inactive'], rowCount: 0 },
  ],
};
...
async function main() {
  ...
  if (witsConfigModel && findField(witsConfigModel, ['sessionId', 'mwdSessionId'])) {
