...
import { createSurveyStation, deleteSurveyStation, getSurveyStationById, getSurveyStations, getSurveyTrajectoryPlotData, importSurveyFromMwdData, importWellPlanCsv, recalculateSurveyStations, updateSurveyStation, } from "../controllers/survey.controller.js";
...
router.post("/well-plan/import-csv", authorize("admin", "engineer"), express.text({
