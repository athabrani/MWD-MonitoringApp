...
export const syncTimestampAndDepth = async (input, db) => {
    const latestRecord = await mwdDataService.getLatestMWDDataBySessionId(input.sessionId, input.excludeId, db);
...
//# sourceMappingURL=timestamp-depth-sync.js.map