...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-xs leading-snug text-muted-foreground sm:text-sm sm:leading-normal", className)} {...props} />
));
