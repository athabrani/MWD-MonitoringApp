...
export const listGatewayRawPacketLogs = async (req, res) => {
    try {
        ...
        if (selectedByFusion !== undefined)
            query.selectedByFusion = selectedByFusion;
        if (ingested !== undefined)
            query.ingested = ingested;
        if (channel)
...
export const getGatewayRawPacketLogById = async (req, res) => {
    try {
...
//# sourceMappingURL=gateway-raw-packet-log.controller.js.map