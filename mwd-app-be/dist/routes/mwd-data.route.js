...
import { createMWDData, getAllMWDData, getMWDDataById, updateMWDData, deleteMWDData, } from "../controllers/mwd-data.controller.js";
import { copyDepthRange, deleteDepthRange, getEditOperations, hideDepthRange, moveDepthRange, previewCopyDepthRange, previewMoveDepthRange, previewRescaleDepthRange, rescaleDepthRange, unhideDepthRange, } from "../controllers/mwd-data-edit.controller.js";
import { authenticate, authorize } from "../middlewares/auth.middleware.js";
import { validateBody } from "../middlewares/validation.middleware.js";
import { mwdDataCreateBodySchema, mwdDataUpdateBodySchema, } from "../utils/request-schemas.js";
const router = Router();
...
router.post("/", authorize("admin", "engineer"), validateBody(mwdDataCreateBodySchema), createMWDData);
router.get("/", getAllMWDData);
router.get("/:id", getMWDDataById);
router.put("/:id", authorize("admin", "engineer"), validateBody(mwdDataUpdateBodySchema), updateMWDData);
router.delete("/:id", authorize("admin", "engineer"), deleteMWDData);
export default router;
//# sourceMappingURL=mwd-data.route.js.map